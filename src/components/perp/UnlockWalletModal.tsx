  ...
  const handleConnect = async () => {
    ...
    if (!isConnected) {
      ...
      if (success && address) {
        ...
        console.log(
          "Wallet unlocked successfully! You can now trade perpetuals.",
        );
      }
  ...
  return (
    <Dialog
      ...
      PaperProps={{
        sx: {
          background:
            "linear-gradient(135deg, rgba(15, 25, 45, 0.98), rgba(5, 12, 25, 0.98))",
    ...
    >
      ...
      <DialogContent sx={{ pt: 3 }}>
        ...
        >
          ...
          >
            By connecting your wallet, you agree to Katana Perps Terms of
            Service. Your wallet will be associated with our trading account via
            a secure signature.
          </Typography>
        </Box>
        ...
        {!isConnected && (
          ...
          >
            Supported wallets: MetaMask, WalletConnect, Coinbase Wallet, and
            more
          </Typography>
        )}
      </DialogContent>
