...
export default function AccountBalanceDisplay() {
  ...
  console.log('[AccountBalanceDisplay] Render:', {
    accountBalance,
    fetchedBalance,
    isLoading,
    isAssociated,
  ...
  useEffect(() => {
    console.log('[AccountBalanceDisplay] Sync effect:', { fetchedBalance });
    if (fetchedBalance) {
      console.log('[AccountBalanceDisplay] Syncing fetchedBalance to store');
  ...
  console.log('[AccountBalanceDisplay] displayBalance:', displayBalance);
